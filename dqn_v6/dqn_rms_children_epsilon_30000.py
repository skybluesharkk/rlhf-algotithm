...
for ep in range(1, NUM_EPISODES+1):
    ...
    if ep % 100 == 0:
        ...
        }, f"student_checkpoint_epsilon_30000_ep{ep}.pt")
...
torch.save(final_save_dict, "student_final_improved_epsilon_30000.pt")
writer.close(); env.close()
my_plot(reward_hist, loss_hist, "student_curve_improved_epsilon_30000.png")