...
# ────────────────────────────────────────────────────────────────────────────────
SEED              = 42
WARMUP_EPISODES   = 20        # 워밍업 기간 단축 (100 -> 50)
NUM_EPISODES      = 1000
MAX_STEPS         = 1000
BATCH_SIZE        = 128
GAMMA             = 0.99
...
writer      = SummaryWriter(log_dir=f"runs/20cosin_improved_exp_{int(time.time())}")
...
torch.save(final_save_dict, "20student_final_improved_cosin.pt")
