...
#이미 BC학습한 파라미터 불러오기
bcpt = torch.load("improved_bc_student_weights.pth", map_location=device)
...
writer      = SummaryWriter(log_dir=f"runs/bc_20_cosin_improved_exp_{int(time.time())}")
...
for ep in range(1, NUM_EPISODES+1):
    ...
    if ep % 100 == 0:
        ...
        }, f"bc_40_cosin_student_checkpoint_ep{ep}.pt")
...
torch.save(final_save_dict, "bc_40_student_final_improved_cosin.pt")
