...
writer      = SummaryWriter(log_dir=f"runs/weak_0.1_40_cosin_improved_exp_{int(time.time())}")
...
for ep in range(1, NUM_EPISODES+1):
    ...
    if ep % 100 == 0:
        ...
        }, f"weak_bc0.1_40_cosin_student_checkpoint_ep{ep}.pt")
...
torch.save(final_save_dict, "weak_bc0.1_40_student_final_improved_cosin.pt")
