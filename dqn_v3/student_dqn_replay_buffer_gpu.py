...
writer = SummaryWriter(log_dir=f"runs/experiment_{current_time}/student_replay_buffer")
...
for i_episode in range(1, NUM_EPISODES + 1):
    ...
    if i_episode % 50 == 0:
        ...
        }, f"student_checkpoint_ep{i_episode}.pt")
...
#  학습 곡선 PNG 저장
# -----------------------------
my_plot(reward_hist, loss_hist, "student_train.png")
