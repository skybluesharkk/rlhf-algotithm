...
writer = SummaryWriter(log_dir=f"runs/experiment_{current_time}_correct_w4/student_replay_buffer")
...
for i_episode in range(1, NUM_EPISODES + 1):
    ...
    if i_episode % 50 == 0:
        ...
        }, f"student_correct_checkpoint_w4_ep{i_episode}.pt")
...
}, "final_student_model_correct_w4.pt")
...
#  학습 곡선 PNG 저장
# -----------------------------
my_plot(reward_hist, loss_hist, "student_train_correct_w4.png")
print("🎉 Student correct w4모델 및 학습 그래프 저장 완료!")
