...
writer = SummaryWriter(log_dir=f"runs/experiment_correct_cnt10_{current_time}/student_replay_buffer")
...
for i_episode in range(1, NUM_EPISODES + 1):
    ...
    if i_episode % 50 == 0:
        ...
        }, f"student_correct_cnt10_checkpoint_ep{i_episode}.pt")
...
}, "final_student_model_correct_cnt10.pt")
...
print("🎉 Student10 모델 및 학습 그래프 저장 완료!")
